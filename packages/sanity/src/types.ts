...
// Query: *[_type == "post" && defined(coalesce(image, mainImage))][0]{      "image": coalesce(image, mainImage){    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  }  }.image
...
// Query: {    "posts": *[_type == "post" && sport->slug.current == $sport] | order(publishedAt desc)[$from...$to]{      ...,        "image": coalesce(image, mainImage){    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  },      "slug": slug.current,        authors[]->{    ...,    "slug": slug.current,      image{    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  }  }    },    "totalPosts": count(*[_type == "post" && sport->slug.current == $sport])  }
...
// Query: *[_type == "post"] | order(publishedAt desc)[0...3]{    _id,    _type,    title,    excerpt,    "slug": slug.current,      "image": coalesce(image, mainImage){    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  },    publishedAt,      authors[]->{    ...,    "slug": slug.current,      image{    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  }  }  }
...
// Query: *[_type == "post"] | order(publishedAt desc)[3..6]{    _id,    title,    excerpt,    "slug": slug.current,    publishedAt,      "image": coalesce(image, mainImage){    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  },      authors[]->{    ...,    "slug": slug.current,      image{    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  }  }  }
...
// Query: *[_type == "school"  ] {    _id,    name,    shortName,    abbreviation,      image{    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  },    conferenceAffiliations,    "relevantAffiliation": conferenceAffiliations[sport->slug.current == $sport][0]  }[defined(relevantAffiliation)] {    _id,    name,    shortName,    abbreviation,      image{    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  },    relevantAffiliation,    "conferenceDetails": *[_type == "conference" && _id == ^.relevantAffiliation.conference._ref][0] {      name,      shortName,      abbreviation,      sportSubdivisionAffiliations    }  }[    count(conferenceDetails.sportSubdivisionAffiliations[      sport->slug.current == $sport &&      subgrouping->slug.current == $subgrouping    ]) > 0  ] | order(shortName asc) {    _id,    name,    shortName,    abbreviation,      image{    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  },    "conferenceInfo": {      "conference": conferenceDetails {        name,        shortName,        abbreviation      }    }  }
...
// Query: *[_type == "school"]{    _id,    _createdAt,    _updatedAt,    name,    shortName,    abbreviation,    nickname,    top25VotingEligible,      image{    ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(caption, asset->altText, asset->originalFilename, "Image-Broken"),  "width": asset->metadata.dimensions.width,  "height": asset->metadata.dimensions.height,  "dominantColor": asset->metadata.palette.dominant.background,  // height/width are required — projecting only x/y makes @sanity/image-url emit rect=...,NaN,...  hotspot {    x,    y,    height,    width  },  crop {    bottom,    left,    right,    top  },  "credit": coalesce(asset->creditLine, attribution, "Unknown")  },    conferenceAffiliations[] {      "conferenceId": conference->_id,      "sportId": sport->_id,    }  }
