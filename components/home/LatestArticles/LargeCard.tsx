...
const LargeCard: FC<LargeCardProps> = ({ post }) => {
  ...
  return (
    <article className="group relative flex h-full flex-col overflow-hidden rounded-md border border-slate-200 dark:border-slate-700">
      <Link href={`/${post.slug}`} prefetch={false}>
        ...
        >
          <div className="relative block h-0 w-full flex-shrink-0 flex-grow overflow-hidden pt-[75%] sm:rounded-b-none sm:pt-[55%]">
