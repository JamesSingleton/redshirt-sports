          ...
          <div className="flex w-full flex-col items-center md:flex-row md:justify-between">
            <div className="flex flex-col items-center md:flex-row">
              ...
              <div className="mt-6 text-center md:mt-0 md:ml-5 md:text-left">
                ...
                <h1 className="font-cal mt-1 text-3xl font-medium tracking-normal text-slate-900 sm:text-4xl md:tracking-tight lg:leading-tight">
                  {author.name}
                </h1>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-xl py-12 px-4 sm:px-12 sm:py-16 md:max-w-3xl lg:max-w-7xl lg:px-8 lg:py-24">
        <div className="w-full lg:grid lg:grid-cols-3 lg:gap-8 xl:gap-12">
          <div className="col-span-2">
            <h2 className="font-cal relative border-b border-slate-300 pb-3 text-2xl font-medium text-slate-900 before:absolute before:left-0 before:-bottom-[1px] before:h-px before:w-24 before:bg-brand-500">
              Recent Articles
            </h2>
          ...
          <div className="mt-12 w-full sm:mt-16 lg:col-span-1 lg:mt-0">
            <div className="w-full rounded-2xl bg-slate-50 p-5 sm:p-8">
              <h2 className="font-cal relative border-b border-slate-300 pb-3 text-2xl font-medium text-slate-900 before:absolute before:left-0 before:-bottom-[1px] before:h-px before:w-24 before:bg-brand-500">{`About ${author.name}`}</h2>
