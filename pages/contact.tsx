          ...
          <div className="w-full lg:flex lg:items-start">
            <div className="lg:w-2/3">
              <div className="mx-auto max-w-xl px-5 sm:px-8 md:max-w-2xl lg:max-w-none lg:px-0 lg:pr-24 xl:pr-48">
                <h2 className="relative border-b border-b-slate-300/70 pb-2 text-2xl font-medium text-slate-900  before:absolute before:left-0 before:-bottom-[1px] before:h-px before:w-24 before:bg-brand-500">
                  Get in touch
                </h2>
