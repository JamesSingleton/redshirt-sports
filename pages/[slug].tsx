  ...
  return (
    <>
      <div className="pt-10 lg:pt-16">
        <header className="container mx-auto px-4 lg:px-32">
          <div className="max-w-screen-md mx-auto">
            <div className="space-y-5">
              <div className="flex flex-wrap space-x-2">
                <a
                  href={`/${categoryName.toLowerCase()}`}
                  className="transition-colors hover:text-white duration-300 nc-Badge relative inline-flex px-2.5 py-1 rounded-full font-medium text-xs !px-3 text-pink-800 bg-pink-100 hover:bg-pink-800"
                >
                  {categoryName}
                </a>
              </div>
