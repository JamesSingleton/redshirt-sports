                ...
                >
                  <div>
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        className="block w-full rounded-md border-slate-300 py-3 px-4 text-slate-900 shadow-sm focus:border-teal-500 focus:ring-teal-500"
                      />
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="sm:col-span-2">
                    <div className="flex justify-between">
                      ...
                      <span id="message-max" className="text-sm text-slate-500">
                        Max. 500 characters
                      </span>
                    </div>
                    <div className="mt-1">
                      <textarea
                        ...
                        name="message"
                        rows={4}
                        className="block w-full rounded-md border border-slate-300 py-3 px-4 text-slate-900 shadow-sm focus:border-teal-500 focus:ring-teal-500"
